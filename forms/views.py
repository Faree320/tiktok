...
def upload_link_form(request):
    if request.method == "POST":
        ...
        clip1 = VideoFileClip("./static/video/your_video_name1.mp4", audio=True).subclip(0, 5)
        clip2 = VideoFileClip("./static/video/your_video_name2.mp4", audio=True).subclip(0, 5)
        clip3 = VideoFileClip("./static/video/your_video_name3.mp4", audio=True).subclip(0, 5)
